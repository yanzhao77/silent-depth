...
- strategy: Cruise toward the reported merchant position (briefing knowledge), ping inside 10 km until the contact reaches TRACKED; no torpedoes (M01 has no sink requirement).
