...
export const SPRITE_MANIFEST: readonly SpriteManifestEntry[] = [
  ...
  { id: 'sprite-destroyer', kind: 'destroyer', name: 'Destroyer — fast escort', type: 'ship', format: 'canvas-2d', width: 512, height: 512, renderScalePx: 60 },
  { id: 'sprite-frigate', kind: 'frigate', name: 'Frigate — compact escort', type: 'ship', format: 'canvas-2d', width: 512, height: 512, renderScalePx: 54 },
  // ---- small units ----
  { id: 'sprite-torpedo', kind: 'torpedo', name: 'Torpedo (north-up, heading = travel)', type: 'unit', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 20 },
  { id: 'sprite-decoy', kind: 'decoy', name: 'Decoy — noise-maker canister', type: 'unit', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 16 },
  // ---- effects / particles ----
  { id: 'fx-sonar-ping', kind: 'sonarPing', name: 'Sonar ping ring (expand frame)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'fx-explosion-particle', kind: 'explosionParticle', name: 'Explosion particle (flash gradient)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'fx-torpedo-wake-bubble', kind: 'torpedoWakeBubble', name: 'Torpedo wake bubble', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'fx-depth-charge-splash', kind: 'depthChargeSplash', name: 'Depth charge splash (ring + droplets)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'fx-contact-uncertainty-ellipse', kind: 'contactUncertaintyEllipse', name: 'Contact uncertainty ellipse (dashed)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'fx-contact-ring-UNKNOWN', kind: 'contactRing', name: 'Contact ring — UNKNOWN (gray)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0, variant: 'UNKNOWN' },
  { id: 'fx-contact-ring-SUSPECTED', kind: 'contactRing', name: 'Contact ring — SUSPECTED (yellow)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0, variant: 'SUSPECTED' },
  { id: 'fx-contact-ring-CLASSIFIED', kind: 'contactRing', name: 'Contact ring — CLASSIFIED (cyan)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0, variant: 'CLASSIFIED' },
  { id: 'fx-contact-ring-TRACKED', kind: 'contactRing', name: 'Contact ring — TRACKED (blue)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0, variant: 'TRACKED' },
  { id: 'fx-contact-ring-CONFIRMED', kind: 'contactRing', name: 'Contact ring — CONFIRMED (red)', type: 'effect', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0, variant: 'CONFIRMED' },
  // ---- map / minimap ----
  { id: 'map-grid-tile', kind: 'mapGridTile', name: 'Map grid tile (5km grid, 18% alpha)', type: 'map', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'minimap-frame', kind: 'minimapFrame', name: 'Minimap frame (panel bg + border)', type: 'minimap', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'minimap-sub-icon', kind: 'minimapSubIcon', name: 'Minimap player-submarine icon', type: 'minimap', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  { id: 'minimap-contact-icon', kind: 'minimapContactIcon', name: 'Minimap contact blip icon', type: 'minimap', format: 'canvas-2d', width: 128, height: 128, renderScalePx: 0 },
  // ---- UI icons (vector-like paths, VISUAL_STYLE §8) ----
  { id: 'icon-sonar', kind: 'uiSonar', name: 'UI icon — sonar', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-contact', kind: 'uiContact', name: 'UI icon — contact', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-torpedo', kind: 'uiTorpedo', name: 'UI icon — torpedo', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-battery', kind: 'uiBattery', name: 'UI icon — battery', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-hull', kind: 'uiHull', name: 'UI icon — hull integrity', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-noise', kind: 'uiNoise', name: 'UI icon — noise', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-detection', kind: 'uiDetection', name: 'UI icon — detection', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-depth', kind: 'uiDepth', name: 'UI icon — depth', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-pause', kind: 'uiPause', name: 'UI icon — pause', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-settings', kind: 'uiSettings', name: 'UI icon — settings', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-map', kind: 'uiMap', name: 'UI icon — map', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
  { id: 'icon-log', kind: 'uiLog', name: 'UI icon — event log', type: 'icon', format: 'svg', width: 32, height: 32, renderScalePx: 0 },
]
...
export function createAtlasSprite(kind: SpriteKind, size: number, opts?: DrawOpts): HTMLCanvasElement {
...
function fillHull(ctx: CanvasRenderingContext2D, p: PaletteColors, u: number, bowY: number, sternY: number, halfWidth: number): void {
...
function fillRectRounded(ctx: CanvasRenderingContext2D, x: number, y: number, w: number, h: number, r: number, fill: string): void {
...
export function drawCargo(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  ...
  for (let r = 0; r < rows.length; r++) {
    for (let c = 0; c < cols.length; c++) {
      const x = cx + cols[c]! * u
      const y = rows[r]! * u
      fillRectRounded(ctx, x, y, boxW, boxH, 1 * u, containerColors[(r + c) % containerColors.length]!)
    }
  }
...
export function drawExplosionParticle(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawTorpedoWakeBubble(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawDepthChargeSplash(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawContactUncertaintyEllipse(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawContactRing(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
...
function isContactState(value: string | undefined): value is ContactState {
  return value === 'UNKNOWN' || value === 'SUSPECTED' || value === 'CLASSIFIED' || value === 'TRACKED' || value === 'CONFIRMED'
}
...
export function drawMinimapFrame(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawMinimapSubIcon(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawMinimapContactIcon(ctx: CanvasRenderingContext2D, size: number, opts?: DrawOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  ctx.save()
  ctx.clearRect(0, 0, size, size)
...
export function drawIconContact(ctx: CanvasRenderingContext2D, size: number, opts?: IconOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  iconBase(ctx, size)
  const cx = 50 * u
...
export function drawIconTorpedo(ctx: CanvasRenderingContext2D, size: number, opts?: IconOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  iconBase(ctx, size)
  const cx = 50 * u
...
export function drawIconBattery(ctx: CanvasRenderingContext2D, size: number, opts?: IconOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  iconBase(ctx, size)
  const color = iconColor(opts, p)
...
export function drawIconDetection(ctx: CanvasRenderingContext2D, size: number, opts?: IconOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  iconBase(ctx, size)
  const color = iconColor(opts, p)
...
export function drawIconSettings(ctx: CanvasRenderingContext2D, size: number, opts?: IconOpts): void {
  const p = resolvePalette(opts?.palette)
  const u = size / 100
  iconBase(ctx, size)
  const cx = 50 * u
...
export function drawSprite(ctx: CanvasRenderingContext2D, kind: SpriteKind, size: number, opts?: DrawOpts): void {
  switch (kind) {
    case 'submarine':
    ...
    case 'contactRing':
      ...
      break
    case 'mapGridTile':
      drawMapGrid(ctx, size, { ...opts, cellPx: opts?.cellPx ?? size / 2, alpha: opts?.alpha ?? 0.18 })
      break
    case 'minimapFrame':
