...
export function el<K extends keyof HTMLElementTagNameMap>(
  ...
  if (props) {
    ...
    if (props.onpointerdown) node.addEventListener('pointerdown', props.onpointerdown as EventListener)
    if (props.onpointermove) node.addEventListener('pointermove', props.onpointermove as EventListener)
