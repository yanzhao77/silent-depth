...
const en = {
  ...
  'hud.decoys': '{n} DECOYS',
  'hud.controls.title': 'CONTROLS',
  'hud.controls.throttle': 'Speed up / down',
  'hud.controls.rudder': 'Turn left / right',
  'hud.controls.depth': 'Change depth layer',
  'hud.controls.ping': 'Active sonar ping',
  'hud.controls.fire': 'Fire torpedo (selected)',
  'hud.controls.silent': 'Silent running',
  'hud.controls.decoy': 'Launch decoy',
  'hud.controls.periscope': 'Raise / lower periscope',
  'hud.controls.lock': 'Lock target',
  'hud.controls.dive': 'Emergency dive',
  'hud.controls.pause': 'Pause menu',
  'hud.controls.screenshot': 'Screenshot',
...
const zh: Dict = {
  ...
  'hud.silent.off': '常规',
  'hud.decoys': '诱饵 {n}',
  'hud.controls.title': '操作与按键',
  'hud.controls.throttle': '加速 / 减速',
  'hud.controls.rudder': '左转 / 右转',
  'hud.controls.depth': '切换深度层',
  'hud.controls.ping': '主动声呐 Ping',
  'hud.controls.fire': '发射鱼雷(选中目标)',
  'hud.controls.silent': '静默运行',
  'hud.controls.decoy': '释放诱饵',
  'hud.controls.periscope': '升起 / 降下潜望镜',
  'hud.controls.lock': '锁定目标',
  'hud.controls.dive': '紧急下潜',
  'hud.controls.pause': '暂停菜单',
  'hud.controls.screenshot': '截图',
  'hud.speedValue': '{v} KT {band}',
...
const fr: Dict = {
  ...
  'hud.controls.title': 'COMMANDES',
  'hud.controls.throttle': 'Accélérer / ralentir',
  'hud.controls.rudder': 'Virer à gauche / droite',
  'hud.controls.depth': 'Changer de couche de profondeur',
  'hud.controls.ping': 'Ping sonar actif',
  'hud.controls.fire': 'Tirer la torpille (cible choisie)',
  'hud.controls.silent': 'Marche silencieuse',
...
const ru: Dict = {
  ...
  'hud.controls.title': 'УПРАВЛЕНИЕ',
  'hud.controls.throttle': 'Ускорение / замедление',
  'hud.controls.rudder': 'Поворот влево / вправо',
  'hud.controls.depth': 'Смена слоя глубины',
  'hud.controls.ping': 'Активный сонар',
  'hud.controls.fire': 'Пуск торпеды (выбранная цель)',
  'hud.controls.silent': 'Тихий ход',
  'hud.controls.decoy': 'Запуск ловушки',
  'hud.controls.periscope': 'Поднять / опустить перископ',
  'hud.controls.lock': 'Захват цели',
  'hud.controls.dive': 'Экстренное погружение',
  'hud.controls.pause': 'Меню паузы',
  'hud.controls.screenshot': 'Скриншот',
  'hud.speedValue': '{v} KT {band}',
