...
const WEATHER_VISUALS: Record<WeatherKind, WeatherVisual> = {
  Clear: {
    ...
    skyHorizon: 0x4a6a8a,
    skyBottom: 0x030a14,
    sunDirection: dir(0.46, 0.76, 0.34),
    sunColor: 0xfff0d0,
    sunIntensity: 1.0,
    moonColor: 0xbcd0e6,
    moonIntensity: 0,
    moonDirection: dir(0.22, 0.62, 0.48),
    starIntensity: 0,
    cloudColor: 0xc9d6e0,
    cloudCover: 0.12,
    fogColor: 0x0c2638,
    ...
    visibilityKm: 16,
    ambientTop: 0x3a6a88,
    ambientBottom: 0x030a14,
    ambientIntensity: 0.35,
    rimColor: 0x88aacc,
    rimIntensity: 0.25,
    oceanDeep: 0x03111e,
    oceanShallow: 0x1a4e68,
    oceanFoam: 0xd4e2e7,
    oceanSubsurface: 0x2e7887,
    lightning: false,
  },
  Cloudy: {
    kind: 'Cloudy',
    ...
    visibilityKm: 12,
    ambientTop: 0x566b79,
    ambientBottom: 0x0d2233,
    ambientIntensity: 0.36,
    rimColor: 0x99afbd,
    rimIntensity: 0.24,
    oceanDeep: 0x04111c,
    oceanShallow: 0x1a3a4d,
    oceanFoam: 0xaab9c4,
    oceanSubsurface: 0x1d4655,
    lightning: false,
  },
  Fog: {
    kind: 'Fog',
    ...
    rimIntensity: 0.2,
    oceanDeep: 0x071420,
    oceanShallow: 0x2b4859,
    oceanFoam: 0xa7b4bd,
    oceanSubsurface: 0x2b505c,
    lightning: false,
  },
  Storm: {
    kind: 'Storm',
    ...
    visibilityKm: 6,
    ambientTop: 0x3d5969,
    ambientBottom: 0x07111f,
    ambientIntensity: 0.41,
    rimColor: 0x63859b,
    rimIntensity: 0.27,
    oceanDeep: 0x020914,
    oceanShallow: 0x112c3d,
    oceanFoam: 0xaebdc5,
    oceanSubsurface: 0x173b4a,
    lightning: true,
  },
  Night: {
    kind: 'Night',
    ...
    skyHorizon: 0x102438,
    skyBottom: 0x02070d,
    sunDirection: dir(0.22, 0.62, 0.48),
    sunColor: 0xaec4dc,
    sunIntensity: 0.5,
    moonColor: 0xbcd0e6,
    moonIntensity: 0.6,
    ...
    visibilityKm: 9,
    ambientTop: 0x21495d,
    ambientBottom: 0x02070d,
    ambientIntensity: 0.36,
    rimColor: 0x5c8bab,
    rimIntensity: 0.36,
    oceanDeep: 0x01070e,
    oceanShallow: 0x0b2130,
    oceanFoam: 0x627b8a,
    oceanSubsurface: 0x0b2834,
    lightning: false,
  },
};
...
const FLASH_DURATION = 0.1; // bright flash
 ...
 */
export function deriveUnderwaterVisuals(
  depthM: number,
  quality: UnderwaterQuality,
): UnderwaterVisual {
  ...
  fogDensity = lerp(fogDensity, 0.2, smoothstep(80, 150, d));
